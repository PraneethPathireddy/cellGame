<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="play.aspx.cs" Inherits="TheCellGame.pages.play" EnableEventValidation="false" %>
                  ...
                  <form runat="server">  
					<asp:GridView ID="scenarioDisplayGridView" runat="server" AutoGenerateColumns="False" GridLines ="None" BprderStype = "None" CellSpacing="5" CellPadding ="5">
                        ...
                        <ItemTemplate>
							...
							<asp:Button runat = "server" id = "scenariButton" text ='<%# Eval("scenarioName") %>' type="submit" class="btn btn-outline-success" OnClick="playButton_Click" />
                        </ItemTemplate>
                         </asp:TemplateField>
                         </Columns>
