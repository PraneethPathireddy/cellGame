...
namespace TheCellGame.admin
{
    public partial class playScenario : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                prevOptionComment.Text = Request.Cookies["optionComment"].Value;
            ...
            if (myRdr.Read())
            {
                ...
                query = "select decisionTreeId, questionId from Linking where decisionTreeId=" + decisionTreeId + " and questionId=" + questionId + "";

                cmd = new SqlCommand(query, conn);
                myRdr = cmd.ExecuteReader();
                GridView1.DataSource = myRdr;
                GridView1.DataBind();
