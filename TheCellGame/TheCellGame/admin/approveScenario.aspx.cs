...
{
    public partial class approveScenario : System.Web.UI.Page
    {
        ...
        protected void ApproveScenaroButton_Click(object sender, EventArgs e)
        {
            ...
            String query = "update Scenarios SET scenarioName='" + scenarioNameStr + "', scenarioDescription='" + scenarioDescriptionStr + "', option1='" + option1Str + "', option2='" + option2Str + "', rightOption=" + optionSelected + ", approvalStatus=1 where scenarioName='" + scenarioNameStr + "'";

            SqlCommand myCommand = new SqlCommand(query, conn);
            myCommand.ExecuteNonQuery();
            conn.Close();

            Response.Redirect("viewApprovalRequests.aspx?");

        }
        protected void RejectScenaroButton_Click(object sender, EventArgs e)
        {
            String scenarioNameStr = scenarioName.Text;
            ...
            String query = "delete from Scenarios where scenarioName='" + scenarioNameStr + "'";
