<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminMaster.Master" AutoEventWireup="true" CodeBehind="approveScenario.aspx.cs" Inherits="TheCellGame.admin.approveScenario" EnableEventValidation="false"  %>
                                       ...
                                       <asp:RadioButtonList ID="optionsRadioList" runat="server" CssClass="form-check-input">
                                        ...
                                        <div class="col-12">
                                           <!-- <button type="submit" class="btn btn-primary">Save</button> -->
											<asp:Button runat = "server" id = "addScenarioButton" text ="Approve" type="submit" class="btn btn-primary" OnClick="ApproveScenaroButton_Click" CauseValidation="false"  />
											   <!-- <button type="submit" class="btn btn-primary">Save</button> -->
											<asp:Button runat = "server" id = "rejectScenarioButton" text ="Reject" type="submit" class="btn btn-danger" OnClick="RejectScenaroButton_Click" CauseValidation="false"  />
                                        </div>
