<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="playScenarioResult.aspx.cs" Inherits="TheCellGame.pages.playScenarioResult" enableEventValidation="false" %>
                ...
                <div class="content-wrapper">
					...
					<div class="row mb-4">
                        <div class="col-lg-12">
                           ...
                           <h2><asp:Label ID="resultLabel" runat="server" ></asp:Label></h2> 
